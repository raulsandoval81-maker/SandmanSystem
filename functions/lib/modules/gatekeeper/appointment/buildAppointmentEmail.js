    ...
    <tr>
      <td align="center" style="padding:24px 12px;">
            ...
            : "Thank you for scheduling your Sandman Combat Admissions Appointment. We look forward to meeting your family, learning more about your athlete, and hearing about your goals.")}
              ...
              <div style="padding:22px;border-radius:14px;background:#fafafa;border:1px solid #e4e4e7;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tr><td style="padding:7px 0;width:34%;font-size:14px;font-weight:700;color:#71717a;">${isAdultAthlete
        ? (lang === "es"
            ? "Participante"
            : "Participant")
        : (lang === "es"
            ? "Atleta"
            : "Athlete")}</td><td style="padding:7px 0;font-size:15px;color:#18181b;">${(0, appointmentFormatting_1.escapeHtml)(participantName)}</td></tr>
                  <tr><td style="padding:7px 0;font-size:14px;font-weight:700;color:#71717a;">${lang === "es" ? "Fecha" : "Date"}</td><td style="padding:7px 0;font-size:15px;color:#18181b;">${(0, appointmentFormatting_1.escapeHtml)(formattedDate)}</td></tr>
                  <tr><td style="padding:7px 0;font-size:14px;font-weight:700;color:#71717a;">${lang === "es" ? "Hora" : "Time"}</td><td style="padding:7px 0;font-size:15px;color:#18181b;">${(0, appointmentFormatting_1.escapeHtml)(formattedTime)}</td></tr>
                  <tr><td style="padding:7px 0;font-size:14px;font-weight:700;color:#71717a;">Coach</td><td style="padding:7px 0;font-size:15px;color:#18181b;">${(0, appointmentFormatting_1.escapeHtml)(appointmentCoach)}</td></tr>
                  <tr><td style="padding:7px 0;font-size:14px;font-weight:700;color:#71717a;">${lang === "es" ? "Academia" : "Academy"}</td><td style="padding:7px 0;font-size:15px;color:#18181b;">${(0, appointmentFormatting_1.escapeHtml)(academyName)}</td></tr>
        ...
        : (isAdultAthlete
            ...
            : "If your athlete will participate, please have them wear comfortable athletic clothing and a plain white T-shirt.")}</li>
                <li>${lang === "es"
        ? (isAdultAthlete
        ...
        : (isAdultAthlete
            ...
            : "Bring a water bottle if your athlete will be participating.")}</li>
        ...
        : "The $25 reservation is collected at the conclusion of your Admissions Appointment. If you enroll, the full amount is immediately credited toward your enrollment."}
              ...
              <p style="margin:0;font-size:15px;line-height:1.7;color:#52525b;white-space:pre-line;">${(0, appointmentFormatting_1.escapeHtml)(lang === "es" ? startingPathMessageEs : startingPathMessage)}</p>
