...
exports.listCompetitionEvents = (0, https_1.onCall)(async (req) => {
    ...
    const actor = await (0, staffAuthorization_1.requireActiveStaff)(req.auth.uid, staffAuthorization_1.OPERATIONAL_STAFF_ROLES, "Active staff access required.");
    ...
    const events = snap.docs
        ...
        .filter((event) => actor.role !== "management" || (Array.isArray(event.locationIds)
        && event.locationIds.some((locationId) => (0, staffAuthorization_1.staffHasLocation)(actor.staff, locationId))))
