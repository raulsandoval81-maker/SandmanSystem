 /**
 * ui-belt.v1.legacy.js
 * ---------------------------------
 * LEGACY / PRESENTATION-ONLY BELT RENDERER
 * - No ladder math
 * - No tier spans
 * - No promotion logic
 * - Do not use for canonical rank decisions
 *
 * Canonical belt = /assets/js/belt-bar.js + /assets/js/ladder.service.js (updateRankUI)
 */
