...
const YOUTH_TIERS = ["Shadow","Recruit","Contender","Competitor","Warrior","Champion","Commander","Hero"];
const F4_TIERS    = ["Apprentice","Warrior","Champion","Veteran","Legend"];
const TIER_XP = 1000, STRIPE_XP = 250;

const BELT_COLOR_MAP = {
  youth:   { Shadow:"#FFFFFF", Recruit:"#FFFF00", Contender:"#FFA500", Competitor:"#2ECC71", Warrior:"#1E90FF", Champion:"#8B59B6", Commander:"#8B4513", Hero:"#000000" },
