...
{ key: "round-2", label: "Round of 2" },
  ...
  function tick() {
    ...
    if (S.round !== 5 && !S.shortCalled && prevTLeft > 10 && S.tLeft <= 10) {
      S.shortCalled = true;
      sayShortTime();
    }
  ...
  if (stageToggle) {
    stageToggle.onclick = () => {
      ...
      stageToggle.textContent =
        document.body.classList.contains("stage") ? "Normal Clock" : "Big Clock";
    };
  }
