...
const SCHEMAS = {
  "quick-45": {
    ...
    focusModes: {
      ...
      "live": [
        { key: "warmup", label: "Warm-up", minutes: 5 },
        { key: "live", label: "Live Wrestling", minutes: 40 }
      ]
    }
  },
  ...
  "standard-60": {
    ...
    maxMinutes: 60,
    blocks: [
      { key: "onmat", label: " On The Mat Talk / Announcements ", minutes: 2 },
      { key: "warmup", label: "Warm Up / Body Mechanics / Agility ", minutes: 8 },
      ...
      { key: "live", label: "Live Wrestling", minutes: 15 },
      { key: "cond", label: "Conditioning / Skill Based Activities", minutes: 5 },
      { key: "offmat", label: "Off The Mat Talk / Roll Call", minutes: 3 }
    ]
  },
  ...
  "elite-90": {
    ...
    blocks: [
      { key: "onmat", label: " On The Mat Talk / Announcements ", minutes: 2 },
      { key: "warmup", label: "Warm Up / Body Mechanics / Agility ", minutes: 10 },
      ...
      { key: "live", label: "Live Wrestling", minutes: 25 },
  ...
  "extended-120": {
    ...
    maxMinutes: 120,
    blocks: [
      { key: "onmat", label: " On The Mat Talk / Announcements ", minutes: 3 },
      { key: "warmup", label: "Warm Up / Body Mechanics / Agility ", minutes: 12 },
      { key: "drills", label: "Review of  prior week's skills", minutes: 20 },
      { key: "technique", label: "Introduction of New Techniques", minutes: 25 },
      { key: "water", label: "💧 Water Break + Mat Games", minutes: 5 },
      { key: "live", label: "Live Wrestling", minutes: 35 },
      { key: "cond", label: " Conditioning / Skill Based Activities", minutes: 15 },
      { key: "offmat", label: "Off The Mat Talk / Roll Call", minutes: 5 }
    ]
  }
};
...
function renderClipboardList() {
  ...
  allCards.forEach(card => {
    ...
    if (lane === "games" && !["elite-90", "extended-120"].includes(currentSchema)) {
      return;
    }
...
function tickInlinePractice() {
  ...
  updateTotalClockDisplay(); // ✅ ADD THIS HERE
...
function startInlinePractice() {
  if (!INLINE_RUN.running) {
    ...
    INLINE_RUN.timerId = setInterval(tickInlinePractice, 1000);
    return;
  }
